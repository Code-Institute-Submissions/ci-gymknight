"""
Django settings for gymknight project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'bj-q&dat*s#3llgecy@d@#7c4(l6h3yico&c*v(bd819p5b81d')
...
WSGI_APPLICATION = 'gymknight.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'ci-gymknight'
...
DEFAULT_FROM_EMAIL = 'orders@gymknight.ie'